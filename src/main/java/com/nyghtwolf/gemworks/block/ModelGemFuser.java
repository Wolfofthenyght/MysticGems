...
public class ModelGemFuser extends ModelBase
{
    ...
    ModelRenderer GrmFuserSepportBase;
    ModelRenderer Pedeastal;
    ...
    public ModelGemFuser()
    {
        ...
        GrmFuserSepportBase = new ModelRenderer(this, 48, 0);
        GrmFuserSepportBase.addBox(0F, 0F, 0F, 8, 2, 8);
        GrmFuserSepportBase.setRotationPoint(-4F, 19F, -4F);
        GrmFuserSepportBase.setTextureSize(128, 64);
        GrmFuserSepportBase.mirror = true;
        setRotation(GrmFuserSepportBase, 0F, 0F, 0F);
        Pedeastal = new ModelRenderer(this, 48, 10);
        Pedeastal.addBox(0F, 0F, 0F, 6, 5, 6);
        Pedeastal.setRotationPoint(-3F, 14F, -3F);
        Pedeastal.setTextureSize(128, 64);
        Pedeastal.mirror = true;
        setRotation(Pedeastal, 0F, 0F, 0F);
